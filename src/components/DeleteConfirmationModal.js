...
/**
 * Component for a delete confirmation modal
 * @param {Function} handleClose - Function to handle the close event of the modal.
 * @param {Function} handleConfirm - Function to handle the confirmation of the delete action.
 */
